...
public class listingcontroller {
    ...
    public ResponseEntity<listing> addlisting(@Valid @RequestBody listing listing, Errors errors, Authentication authentication, @PathVariable("productId") Integer productId) throws InvalidInputFormat, SomethingWentWrongException {
        if(errors.hasErrors()){
        ...
        return listingservice.addlisting(listing, authentication, productId);
    }
    ...
    public ResponseEntity<List<listing>> getmylistings(Authentication authentication) throws SomethingWentWrongException {
        return listingservice.getmylistings(authentication);
    }
    @GetMapping("modify/{id}")
    public ResponseEntity<listing>modifylisting(Authentication authentication, @PathVariable("id") Integer id, @RequestBody listing listing) throws InvalidInputFormat, SomethingWentWrongException {
        return listingservice.modifylisting(authentication, id, listing);
    }
